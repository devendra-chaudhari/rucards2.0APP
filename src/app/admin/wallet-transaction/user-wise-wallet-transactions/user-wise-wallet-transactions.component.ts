...
@Component({
  selector: 'app-user-wise-wallet-transactions',
  templateUrl: './user-wise-wallet-transactions.component.html',
  styleUrls: ['./user-wise-wallet-transactions.component.scss']
})
export class UserWiseWalletTransactionsComponent {
  ...
  ngOnInit(): void {
    this.breadCrumbItems = [
      ...
      {label: 'User Wise Wallet Transaction', active: true}
    ];
    this.getUsers();
  }
